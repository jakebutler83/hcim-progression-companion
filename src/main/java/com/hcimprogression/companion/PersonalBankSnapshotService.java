...
public class PersonalBankSnapshotService
{
    public PersonalBankSnapshot createSnapshot(
        Client client,
        ...
        ItemContainer container)
    {
        ...
        PersonalBankSnapshot snapshot = new PersonalBankSnapshot();
        ...
        if (items != null)
        {
            for (Item item : items)
            {
                ...
                snapshot.getItems().add(new PersonalBankSnapshot.PersonalBankItem(
                    canonicalItemId,
                    rawItemId,
                    name.trim(),
                    item.getQuantity()
